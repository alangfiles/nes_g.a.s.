...
; one_vram_buffer(pointer[960 + attribute_bytes_written], attribute_table_index);
;
L5890:	lda     _attribute_bytes_written
	clc
	adc     #$C0
	pha
	lda     #$00
...
; ++moveframes;
;
L80C0:	inc     _moveframes
	bne     L80DB
	inc     _moveframes+1
;
; ++moveframes2;
;
L80DB:	inc     _moveframes2
	bne     L80DD
	inc     _moveframes2+1
;
; if (levels_complete == 0)
;
L80DD:	lda     _levels_complete
	jne     LD7CB
;
; ++blimp_frames;
;
...
; ++moveframes2;
;
L839B:	inc     _moveframes2
	bne     L839D
	inc     _moveframes2+1
;
; ppu_wait_nmi(); // wait till beginning of the frame
;
L839D:	jsr     _ppu_wait_nmi
;
; oam_clear();
;
	jsr     _oam_clear
...
;
LA301:	lda     #>(_alien_evaluation_text_bad)
	sta     _pointer+1
...
; ++moveframes;
;
LA50B:	inc     _moveframes
	bne     LA523
	inc     _moveframes+1
;
; if (moveframes % 2 == 0)
;
LA523:	lda     _moveframes
	and     #$01
	bne     LD807
;
; ++moveframes2;
...
; ++moveframes;
;
LA6AA:	inc     _moveframes
	bne     LA6B8
	inc     _moveframes+1
;
; ++moveframes2;
;
LA6B8:	inc     _moveframes2
	bne     LA6BA
	inc     _moveframes2+1
;
; index3 = 0;
...
; ++attribute_bytes_written;
;
LD827:	inc     _attribute_bytes_written
;
; for (index = 0; index < 4; ++index)
;
	inc     _index
...
;
LD84F:	sta     _column_pixel_counter
;
; ++row_column_index;
;
