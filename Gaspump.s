...
;
L403D:	lda     _attribute_bytes_written
	cmp     #$40
	bcs     L403E
;
...
; ---------------------------------------------------------------
; void __near__ bank3_loop (void)
; ---------------------------------------------------------------

.segment	"BANK3"

.proc	_bank3_loop: near
...
L4063:	jsr     _banked_call
;
; if (game_mode == MODE_TITLE)
;
L4064:	lda     _game_mode
	jne     L4068
;
; ppu_wait_nmi();
;
