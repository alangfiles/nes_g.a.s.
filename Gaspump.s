...
L2BB5:	ldy     #$00
	...
	ldx     #$22
	lda     #$82
L2BB1:	jsr     _multi_vram_buffer_horz
;
; flush_vram_update2();
;
	jsr     _flush_vram_update2
...
;
L2BBE:	lda     _screen_line_counter
	cmp     #$F1
	bcc     L2BC0
;
; ++scroll_page;
