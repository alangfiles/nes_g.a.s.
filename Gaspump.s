...
L3C3E:	ldy     #$00
	...
	ldx     #$22
	lda     #$82
L3C3A:	jsr     _multi_vram_buffer_horz
;
; flush_vram_update2();
;
	jsr     _flush_vram_update2
...
;
L3172:	lda     _screen_line_counter
	cmp     #$F1
	jcc     L3C4D
;
; set_chr_bank_0(CUTSCENE_CHR_0);
