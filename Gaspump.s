...
L2BF3:	ldy     #$00
	...
	ldx     #$22
	lda     #$82
L2BEF:	jsr     _multi_vram_buffer_horz
;
; flush_vram_update2();
;
	jsr     _flush_vram_update2
...
;
L2BFC:	lda     _screen_line_counter
	cmp     #$F1
	bcc     L2BFE
;
; ++scroll_page;
