...
L3C40:	ldy     #$00
	...
	ldx     #$22
	lda     #$82
L3C3C:	jsr     _multi_vram_buffer_horz
;
; flush_vram_update2();
;
	jsr     _flush_vram_update2
...
;
L3174:	lda     _screen_line_counter
	cmp     #$F1
	jcc     L3C4F
;
; set_chr_bank_0(CUTSCENE_CHR_0);
