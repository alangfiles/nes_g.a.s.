...
;
L48BE:	lda     _attribute_bytes_written
	cmp     #$40
	bcs     L48BF
;
...
; ---------------------------------------------------------------
; void __near__ bank_4_level_init (void)
; ---------------------------------------------------------------

.segment	"BANK4"

.proc	_bank_4_level_init: near
...
;
	lda     #$04
	jsr     pusha
	lda     #<(_bank_4_level_init)
	ldx     #>(_bank_4_level_init)
	jmp     _banked_call
